  ...
  <div class=" px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32 bg-white dark:bg-slate-900">
    <div class="mx-auto max-w-7xl">
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 dark:text-slate-300 sm:text-7xl">Develop
        ...
        ></path></svg><span class="relative">Easy & Smart </span></span>
      </h1>
      ...
      >
        ...
        <span class="ml-3 dark:text-slate-300">Танилцуулга бичлэг</span></a></div>
      <div class="mt-36 lg:mt-44"><p class="font-display text-base text-slate-900 dark:text-slate-400">ХЭРЭГЛЭГЧ БОЛОН ЗАХИАЛАГЧ</p>
        <ul role="list"
        ...
        >
          <li>
            <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
              <li class="flex"><img alt="Transistor" src="https://lambda-platform.github.io/images/client/MMHI_logo.svg"
                                    width="158"
                                    height="48" decoding="async" data-nimg="future" loading="lazy"
              ></li>
              <li class="flex"><img alt="Tuple" src="https://lambda-platform.github.io/images/client/iCT.svg" width="105"
                                    height="48"
                                    decoding="async" data-nimg="future" loading="lazy"
              ></li>
              <li class="flex"><img alt="StaticKit" src="https://lambda-platform.github.io/images/client/MLSP.svg"
                                    width="127"
                                    height="48" decoding="async" data-nimg="future" loading="lazy"
              ></li>
            </ul>
          ...
          <li>
            <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
              <li class="flex"><img alt="Mirage" src="https://lambda-platform.github.io/images/client/ITDUB_logo.svg"
                                    width="138" height="48"
                                    decoding="async" data-nimg="future" loading="lazy"
              ></li>
              <li class="flex"><img alt="Laravel" src="https://lambda-platform.github.io/images/client/ADB_svg.svg"
                                    width="136" height="48"
                                    decoding="async" data-nimg="future" loading="lazy"
              ></li>
              <li class="flex"><img alt="Statamic" src="https://lambda-platform.github.io/images/client/ASI_logo.svg"
                                    width="147" height="48"
                                    decoding="async" data-nimg="future" loading="lazy"
              ></li>
            </ul>

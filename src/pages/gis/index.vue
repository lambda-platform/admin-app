<template>
  <div class="w-full">
    <div class="grid grid-cols-12 2xl:grid-cols-10 map-container h-screen border-t border-slate-100 dark:border-slate-900">
      <div class="col-span-12 lg:col-span-4 xl:col-span-3 2xl:col-span-2 p-4 overflow-y-auto bg-slate-50 dark:bg-slate-900">

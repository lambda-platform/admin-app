import {dia, shapes, ui} from '@clientio/rappid/rappid';

import {enableVirtualRendering} from './features/virtual-rendering';
import {toolbarConfig} from './config/toolbar.config';
import {BACKGROUND_COLOR, SECONDARY_BACKGROUND_COLOR, GRID_SIZE, PADDING_L, PADDING_S, OUT_PORT_LABEL} from '../theme';
import './shapes';

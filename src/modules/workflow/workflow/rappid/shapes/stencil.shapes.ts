...
import { dia, shapes } from '@clientio/rappid/rappid';
...
export enum ShapeTypesEnum {
  ...
  FLOWCHART_CANCEL = 'stencil.FlowchartCancel',
  FLOWCHART_POSTPONE = 'stencil.FlowchartPostpone',
}
...
const FlowchartCancel = dia.Element.define(ShapeTypesEnum.FLOWCHART_CANCEL, {
...
const FlowchartPostpone = dia.Element.define(ShapeTypesEnum.FLOWCHART_POSTPONE, {
